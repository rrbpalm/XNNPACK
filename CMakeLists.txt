...
message("===================XNNPACK_TARGET_PROCESSOR " ${XNNPACK_TARGET_PROCESSOR})
...
IF(CMAKE_SYSTEM_PROCESSOR MATCHES "^armv[5-8]" OR IOS_ARCH MATCHES "^armv7")
  ...
  IF(IOS)
    ...
    SET_PROPERTY(SOURCE ${XNNPACK_AARCH32_ASM_MICROKERNEL_SRCS} APPEND_STRING PROPERTY COMPILE_FLAGS " ${IOS_ARCH} ")
...
IF(XNNPACK_TARGET_PROCESSOR MATCHES "^(aarch64|arm64)$" OR IOS_ARCH MATCHES "^arm64.*")
  ...
  IF(IOS)
    SET_PROPERTY(SOURCE ${XNNPACK_AARCH64_ASM_MICROKERNEL_SRCS} APPEND_STRING PROPERTY COMPILE_FLAGS " ${IOS_ARCH} ")
  ENDIF()
...
IF(EMSCRIPTEN)
  IF(XNNPACK_WITH_WASM_SIMD)
    SET_PROPERTY(SOURCE ${XNNPACK_MICROKERNEL_SRCS} APPEND_STRING PROPERTY COMPILE_FLAGS " -msimd128 ")
